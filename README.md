...
- [**Architectural Patterns**](./Architectural/README.md) 🏛️: Explore high-level patterns that deal with the overall layout of application components and data flow.
